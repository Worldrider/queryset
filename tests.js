...
QuerySet.setConfig({separator: "__"})
...
assertEqual(qs.update({test_field: 42}).values_list("test_field").distinct(), [42])
assertEqual(qs.update({test_field: 42}).values_list("test_field").distinct().sum(), 42)
assertEqual(qs.update({test_field: 42}).values_list("test_field").distinct().avg(), 42)
assertEqual(qs.update({test_field: 42}).avg("test_field"), 42)
